package core.machine.machines.definition;
...
public class Block {
    ...
    //TODO: pass texture region into constructor so we do not need to pass assets in
    public Machine init(int tileX, int tileY, Direction direction) {
