    ...
    final float[] vertices = this.vertices;
        ...
        for (int col = col1; col < col2; col++) {
            ...
            if (tile != null) {
                ...
                //set colored cell to current colored cell set if there is one
                float cellColor = color;

                if (cell instanceof World.ColoredCell coloredCell) {
                    cellColor = coloredCell.getColor().toFloatBits();
                }

                vertices[X1] = x1;
                vertices[Y1] = y1;
                vertices[C1] = cellColor;
                vertices[U1] = u1;
                vertices[V1] = v1;

                vertices[X2] = x1;
                vertices[Y2] = y2;
                vertices[C2] = cellColor;
                vertices[U2] = u1;
                vertices[V2] = v2;

                vertices[X3] = x2;
                vertices[Y3] = y2;
                vertices[C3] = cellColor;
                vertices[U3] = u2;
                vertices[V3] = v2;

                vertices[X4] = x2;
                vertices[Y4] = y1;
                vertices[C4] = cellColor;
                vertices[U4] = u2;
                vertices[V4] = v1;
