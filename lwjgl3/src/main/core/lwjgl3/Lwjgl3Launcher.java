...
import core.app.launcher.GameLauncher;
...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        configuration.setTitle("2D machines game");
...
//        );
        ...
        configuration.setStencilBits(8); // Set stencil bits to 8
        configuration.setSamples(8); // Enable 8x MSAA
